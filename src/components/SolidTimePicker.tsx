...
const SolidTimePicker = (props: any) => {
  ...
  return (
    <div class="flex flex-col w-full">
      <div class={`${props.errors.error ? '!border-red-500' : ''} flex bg-white relative w-full border rounded-lg bg-gray-50 dark:bg-gray-700 border-gray-300 dark:border-gray-600 bg`}>
