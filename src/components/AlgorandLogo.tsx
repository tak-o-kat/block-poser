interface AlgorandLogoProps {
  size?: string | number; // allows passing size as "10px" or 10
}

const AlgorandLogo = (props: AlgorandLogoProps) => {
  const size = props.size || "10px"; // default size if not provided

  return (
    <div class="fill-teal-600 dark:fill-teal-600">
      <svg
        id="Layer_1"
        data-name="Layer 1"
