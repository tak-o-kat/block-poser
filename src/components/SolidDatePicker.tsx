...
const SolidDatePicker = (props: any) => {
  ...
  const dateInputClasses = "bg-white dark:bg-gray-700 outline-none h-11 !pl-8 cursor-pointer";
  ...
  return (
    <div class="flex flex-col w-full">
      <div class={`${props.errors.error ? '!border-red-500' : ''} bg-white relative w-full border rounded-lg bg-gray-50 dark:bg-gray-700 border-gray-300 dark:border-gray-600`}>
